...
int tx = 7;
int iRSensorPin = 3;
int knockSensor1 = A2;//A1;//A0;
int knockSensor2 = A0;//A2;//A1;
int knockSensor3 = A1;//A0;//A2;
int TRIGGER_PIN = 5;
int ECHO_PIN = 6;
...
#define HW__VERSION_CODE 10183 // " version "SEN-10183" (HMC5843 magnetometer)
...
#define ACCEL_Y_MAX ((float) 302)
#define ACCEL_Z_MIN ((float) -304)
#define ACCEL_Z_MAX ((float) 261)
...
const float magn_ellipsoid_center[3] = {-67.7627, -214.425, 184.834};
const float magn_ellipsoid_transform[3][3] = {{0.913426, -0.0215553, -0.00507036}, {-0.0215553, 0.993569, -0.0122675}, {-0.00507036, -0.0122675, 0.885848}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -66.25)
#define GYRO_AVERAGE_OFFSET_Y ((float) 18.05)
#define GYRO_AVERAGE_OFFSET_Z ((float) 42.5)
